...
import javax.swing.border.TitledBorder;
 ...
 private void assembleInterface() {
    ...
    p_1 = new JPanel(new GridLayout(1,1));
    p_1.setForeground(Color.WHITE);
    p_1.setBackground(Color.BLACK);
    message.setBackground(SystemColor.menu);
    message.setForeground(Color.WHITE);
    p_1.add(new JScrollPane(message));
    message.setFont(new Font("Arial",Font.BOLD,20));
    p_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Decoded message", TitledBorder.LEADING, TitledBorder.TOP, null, Color.WHITE));
    message.setEditable(false);
    this.getContentPane().add(p_1, BorderLayout.SOUTH);
    
    imagePane.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Steganographed Image", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLACK));
