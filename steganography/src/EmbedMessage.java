...
//       getMaximumWindowBounds());
 ...
 private void assembleInterface() {
   ...
   save.addActionListener(this);   
    ...
    p_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Message to be embedded", TitledBorder.LEADING, TitledBorder.TOP, null, Color.WHITE));
    this.getContentPane().add(p_1, BorderLayout.NORTH);
 ...
 private void openImage() {
    ...
    try {   
       ...
       originalPane.setViewportView(l);
       this.validate();
